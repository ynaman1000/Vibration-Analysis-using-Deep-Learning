...
if __name__ == '__main__':
    ...
    print("Total Time taken by CPU+parallel: ", end-start)
    analysis_file.write("\n")
    analysis_file.write(','.join["Total Time taken by CPU+parallel(in seconds)", repr(end-start)])
    analysis_file.write("\n")
    analysis_file.close()
