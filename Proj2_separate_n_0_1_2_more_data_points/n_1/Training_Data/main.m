...
n = 1;      % exponent in area and moment of inertia; I1*eta^(n+2), A1*eta^n 
eta0 = linspace(1e-8, 0.6018, 10000);   % fraction of truncated portion, keep less than (0.6047 for n=0, 0.6018 for n=1, 0.5989 for n=2)
