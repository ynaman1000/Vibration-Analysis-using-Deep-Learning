...
# modelfile_folder = "Final_tuning_models/Case1_L1_N1/"
modelfile_folder = "Final_tuning_models/Case2_L1_N1/"
...
file_folder = "Per_dev_csv/Case2_L1_N1/"
...
for modelfile_name in modelfile_names:
    ...
    if make_report:
        ...
        for i in range(numDataPts):
            report.write(','.join([repr(e) for e in test_data_input[i].tolist()] + [repr(e) for e in test_per_dev[i].tolist()] + ["\n"]))
