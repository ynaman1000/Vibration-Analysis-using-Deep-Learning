...
numDataPts = 15000*701     # total number of data points
case = 2
...
numIter = 30000            # number of iterations for training
...
if numHypParamSamples == 1:
    ...
    L1 = 10                   # number of hidden layers with activation function
    N1 = 173                 # number of units per hidden layer with activation function
    ...
    log10initLRInt = [-2, -2]
    lrUpdateCoeffInt = [5, 6]
    lrUpdatePeriodInt = [5000, 5001]
    L1Int = [5, 10]
    N1Int = [150, 250]
    L2Int = [1, 2]
    N2Int = [3, 4]
