...
datafile_folder = "csv/"
datafile_name = "plot_data_n-1_2_3_4_6_8_per_dev"
datafile_ext = ".csv"
...
plt_folder = "plots/"
plt_name = "plot_n-1_2_3_4_6_8_per_dev"
...
def plotter(x_data, y_data, fig_nm, subplot_rows, subplot_cols, y_max):
    ...
    fig.suptitle("Percent Deviations vs \u03B4"+r"$_{0}$"+" for different values of \u03B7", fontsize=16)
    fig.legend(tuple(l) , ("\u03B7=1", "\u03B7=2", "\u03B7=3", "\u03B7=4", "\u03B7=6", "\u03B7=8"), loc = 'lower center', ncol=6, labelspacing=0. )
